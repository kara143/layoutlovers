...
$webMvcFolder = Join-Path $slnFolder "src/layoutlovers.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/layoutlovers.Web.Public"
...
dotnet restore layoutlovers.Web.sln
