...
using layoutlovers.Auditing.Exporting;
...
using EntityHistoryHelper = layoutlovers.EntityHistory.EntityHistoryHelper;

namespace layoutlovers.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : layoutloversAppServiceBase, IAuditLogAppService
    {
