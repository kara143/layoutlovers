...
using layoutlovers.Migrations.Seed.Host;
...
namespace layoutlovers.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : layoutloversAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<layoutloversDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{layoutloversConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{layoutloversConsts.ConnectionStringName}", constring);
        }
