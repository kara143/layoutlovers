...
{
    public class SessionAppService : layoutloversAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    CurrencySign = layoutloversConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = layoutloversConsts.AllowTenantsToChangeEmailSettings,
