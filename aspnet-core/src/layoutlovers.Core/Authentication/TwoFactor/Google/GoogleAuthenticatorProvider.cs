...
namespace layoutlovers.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : layoutloversServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("layoutlovers", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
