...
{
    public class StripeGatewayManager : layoutloversServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "layoutlovers";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + layoutloversConsts.Currency;
        }
