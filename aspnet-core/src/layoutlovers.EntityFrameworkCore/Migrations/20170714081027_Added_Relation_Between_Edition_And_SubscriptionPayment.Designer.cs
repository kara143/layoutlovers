...
namespace layoutlovers.Migrations
{
    ...
    partial class Added_Relation_Between_Edition_And_SubscriptionPayment
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("layoutlovers.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("layoutlovers.Chat.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("layoutlovers.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("layoutlovers.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("layoutlovers.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("layoutlovers.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("layoutlovers.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("layoutlovers.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
