...
namespace layoutlovers.Migrations
{
    ...
    [Migration("20220121122900_Added_Properties_to_LayoutProduct")]
    partial class Added_Properties_to_LayoutProduct
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("layoutlovers.LayoutProducts.LayoutProduct", b =>
                {
                    ...
                    b.Property<int>("AlternativeGridType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("layoutlovers.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("layoutlovers.PurchaseItems.PurchaseItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("layoutlovers.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("layoutlovers.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("layoutlovers.PurchaseItems.PurchaseItem", b =>
                {
                    ...
                    b.HasOne("layoutlovers.Purchases.Purchase", "Purchase")
                        .WithMany("PurchaseItems")
