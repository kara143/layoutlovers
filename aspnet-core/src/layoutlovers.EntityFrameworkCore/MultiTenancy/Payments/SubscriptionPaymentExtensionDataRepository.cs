...
using layoutlovers.EntityFrameworkCore.Repositories;

namespace layoutlovers.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : layoutloversRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<layoutloversDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
