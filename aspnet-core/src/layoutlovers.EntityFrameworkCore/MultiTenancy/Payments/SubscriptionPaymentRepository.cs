...
{
    public class SubscriptionPaymentRepository : layoutloversRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<layoutloversDbContext> dbContextProvider)
