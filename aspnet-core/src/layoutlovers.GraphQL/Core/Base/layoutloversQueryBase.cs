...
namespace layoutlovers.Core.Base
{
    public abstract class layoutloversQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected layoutloversQueryBase(string fieldName,
