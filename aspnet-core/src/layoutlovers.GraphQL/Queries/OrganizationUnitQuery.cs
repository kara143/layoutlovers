...
using layoutlovers.Core.Base;
using layoutlovers.Core.Extensions;
using layoutlovers.Dto;
using layoutlovers.Types;

namespace layoutlovers.Queries
{
    public class OrganizationUnitQuery : layoutloversQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
