...
using layoutlovers.Commands;
using layoutlovers.Core.Threading;
using layoutlovers.Models.NavigationMenu;
using layoutlovers.Services.Navigation;
...
using layoutlovers.Controls;
using layoutlovers.Dto;
using layoutlovers.Extensions;
using layoutlovers.Localization;
using layoutlovers.UI;
using layoutlovers.UI.Assets;
using layoutlovers.Views;
using DependencyResolver = layoutlovers.Core.Dependency.DependencyResolver;
...
namespace layoutlovers.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "layoutlovers";
