...
namespace layoutlovers.Web.Authentication.JwtBearer
{
    public class layoutloversJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public layoutloversJwtSecurityTokenHandler()
        {
