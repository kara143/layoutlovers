...
using layoutlovers.Authentication.TwoFactor;
using layoutlovers.Chat;
using layoutlovers.Configuration;
using layoutlovers.EntityFrameworkCore;
using layoutlovers.Startup;
using layoutlovers.Web.Authentication.JwtBearer;
using layoutlovers.Web.Authentication.TwoFactor;
using layoutlovers.Web.Chat.SignalR;
using layoutlovers.Web.Configuration;
using layoutlovers.Web.DashboardCustomization;

namespace layoutlovers.Web
{
    [DependsOn(
        typeof(layoutloversApplicationModule),
        typeof(layoutloversEntityFrameworkCoreModule),
    ...
    public class layoutloversWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public layoutloversWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(layoutloversApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(layoutloversWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(layoutloversWebCoreModule).Assembly);
        }
