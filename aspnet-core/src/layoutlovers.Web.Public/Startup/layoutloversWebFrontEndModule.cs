...
namespace layoutlovers.Web.Public.Startup
{
    ...
    public class layoutloversWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public layoutloversWebFrontEndModule(IWebHostEnvironment env, layoutloversEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(layoutloversWebFrontEndModule).GetAssembly());
        }
    }
}
