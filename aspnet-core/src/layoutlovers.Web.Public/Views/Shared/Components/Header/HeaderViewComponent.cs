...
using layoutlovers.Web.Public.Startup;
using layoutlovers.Web.Session;

namespace layoutlovers.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : layoutloversViewComponent
    {
