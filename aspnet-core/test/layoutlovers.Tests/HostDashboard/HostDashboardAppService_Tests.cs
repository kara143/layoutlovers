...
using layoutlovers.MultiTenancy.HostDashboard;
...
namespace layoutlovers.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(layoutloversDbContext context, SubscriptionPayment subscriptionPayment)
        {
